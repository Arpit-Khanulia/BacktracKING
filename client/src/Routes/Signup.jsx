    ...
    try {
      ...
      if (response.status !== 200) {
        ...
        if (response.data.userexists == 1) {
          ...
          // Replace window.alert() with an appropriate method for your environment
          navigate("/");
  ...
  return (
    <div>
      <div className="w-full h-screen p-4 flex justify-center items-center overflow-hidden">
        <main className="w-full md:w-5/6 xl:w-4/6 h-9/10 flex items-center bg-1D232A rounded-lg font-mono">
          <div className="w-full sm:w-1/2 md:w-1/3 p-10 grid grid-cols-1 space-y-4">
            ...
            <span className="font-bold text-2xl">Register your account</span>
            <div className="space-y-2">
              ...
              <Link to="/problems">
                <button
                  ...
                  className="w-full focus:outline-none text-white text-sm py-2.5 px-5 rounded-md bg-purple-500 hover:bg-purple-600 hover:shadow-lg mt-2"
                >
                  Register
                </button>
              </Link>
